...
namespace FishingChestTweaks
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        public static PerScreen<float> ChestPosition = new PerScreen<float>(() => -1);
        public static PerScreen<float> CatchLevel = new PerScreen<float>(() => -1);
        public static PerScreen<float> ChestTargetPosition = new PerScreen<float>(() => -1);
        public static PerScreen<float> ChestAcceleration = new PerScreen<float>(() => 0);
        public static PerScreen<float> FSAcceleration = new PerScreen<float>(() => 0);
        public static PerScreen<float> ChestSpeed = new PerScreen<float>(() => 0);
