...
namespace StardewOpenWorld
{
    public class ModConfig
    {
        ...
        public int TilesPerChestMin { get; set; } = 2000;
        public int TilesPerChestMax { get; set; } = 50000;
        ...
        public int TilesPerClumpMin { get; set; } = 5000;
        public int TilesPerClumpMax { get; set; } = 10000;
