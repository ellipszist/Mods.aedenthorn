            ...
            if (configMenu is not null)
            {
                ...
                if (configMenuExt is not null)
                {
                    configMenuExt.AddColorOption(
                        mod: ModManifest,
                        getValue: () => Config.ColorHigh,
                        setValue: (c) => Config.ColorHigh = c,
                        name: () => SHelper.Translation.Get("ColorHigh")
                    );
                    configMenuExt.AddColorOption(
                        mod: ModManifest,
                        getValue: () => Config.ColorMid,
                        setValue: (c) => Config.ColorMid = c,
                        name: () => SHelper.Translation.Get("ColorMid")
                    );
                    configMenuExt.AddColorOption(
                        mod: ModManifest,
                        getValue: () => Config.ColorLow,
                        setValue: (c) => Config.ColorLow = c,
                        name: () => SHelper.Translation.Get("ColorLow")
                    );
                }
            }
        }
