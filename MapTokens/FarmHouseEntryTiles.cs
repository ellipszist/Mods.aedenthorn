...
namespace MapTokens
{
    internal class FarmHouseEntryTiles : PropertyTile
    {

        public FarmHouseEntryTiles(int _which = 0, string _s = " ") : base(_which, _s)
        {
        }
        ...
        public override bool UpdateContext()
        {
            ...
            foreach (var b in farm.buildings)
            {
                if (b.buildingType.Value != "FarmHouse" && b.buildingType.Value != "Cabin")
                    continue;
                var entry = new Point(b.tileX.Value + b.humanDoor.X, b.tileY.Value + b.humanDoor.Y + 1);
                newList.Add(GetString(entry));
            }
