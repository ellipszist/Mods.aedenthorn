...
namespace PortableFurnace
{
    public partial class ModEntry
    {
        ...
        public static float GetFurnaceSpeed(Item item)
        {
            ...
            switch (item.Name)
            {
                case "aedenthorn.PortableFurnace_CopperFurnace":
                    return Config.TimeMultCopper;
                case "aedenthorn.PortableFurnace_IronFurnace":
                    return Config.TimeMultIron;
                case "aedenthorn.PortableFurnace_GoldFurnace":
                    return Config.TimeMultGold;
                case "aedenthorn.PortableFurnace_IridiumFurnace":
