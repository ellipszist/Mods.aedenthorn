...
namespace CustomCraneGame
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        public const string dictPath = "aedenthorn.CustomCraneGame/dict";
        public const string normalKey = "aedenthorn.CustomCraneGame/normal";

        public static Dictionary<string, CraneGameData> GameDataDict 
        { 
            get
            {
                return SHelper.GameContent.Load<Dictionary<string, CraneGameData>>(dictPath);
            } 
        }
        public static PerScreen<string> lastQuestion = new();
        public static PerScreen<GameLocation.afterQuestionBehavior> lastBehavior = new();
        public static PerScreen<string> lastGameChoice = new();
        ...
        private void Content_AssetRequested(object sender, AssetRequestedEventArgs e)
        {
            ...
            {
                e.LoadFrom(() => new Dictionary<string, CraneGameData>(), AssetLoadPriority.Exclusive);
            }
        }
