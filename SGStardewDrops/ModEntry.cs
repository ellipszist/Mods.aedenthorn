...
namespace SGStardewDrops
{
	public partial class ModEntry : Mod
	{
		...
		public static string boxId = "aedenthorn.SGStardewDrops_puzzle_box";
		public static string infoKey = "aedenthorn.SGStardewDrops/info";
        public static ISGStardewDropsAPI sgapi;
        ...
        private void Content_AssetRequested(object sender, StardewModdingAPI.Events.AssetRequestedEventArgs e)
        {
			...
			if(Config.ModEnabled && e.NameWithoutLocale.IsEquivalentTo("Data/Shops"))
			{
				e.Edit((IAssetData data) =>
				{
					data.AsDictionary<string, ShopData>().Data["Carpenter"].Items.Add(new ShopItemData()
					{
						Id = boxId,
						ItemId = boxId,
					});
		...
		{
			sgapi = SHelper.ModRegistry.GetApi<ISGStardewDropsAPI>("aedenthorn.StardewGames");
