...
{
    public class StardewDropsGameMenu : IClickableMenu
    {
        public static StardewDropsGameMenu instance;
        ...
        public SDDPieceType[,] pieces = null;
        ...
        public SDDGameData data;

        public StardewDropsGameMenu(Object box) : base(0, 0, Game1.uiViewport.Width, Game1.uiViewport.Height)
        {
            instance = this;
            if (box is not null)
            {
            ...
            if (box != null)
            {
                ...
                if (box.modData.TryGetValue(ModEntry.infoKey, out var dataStr))
                {
                    ...
                    gameType = info.mapPath;
                    LoadGame();
                    mapData = mapsDataDict[gameType];
        ...
        private void LoadGame()
        {
            ...
            map = ModEntry.SHelper.GameContent.Load<Map>(gameType);
        ...
        private void CleanupBeforeExit(IClickableMenu menu)
        {
            ...
            (menu as StardewDropsGameMenu).box.modData[ModEntry.infoKey] = JsonConvert.SerializeObject(info);
        }
        ...
        private void RebuildElements()
        {
            ...
            mapDropdown.SetCurrentItem(gameType);
        ...
        public override void releaseLeftClick(int x, int y)
        {
            ...
            if (mapDropdown.clicked)
            {
                ...
                gameType = mapDropdown.GetCurrentItem();
                ReloadMap();
                RebuildElements();
            }
