...
namespace SGStardewDrops
{
    public class TileList
    {
        ...
        public void Draw(SpriteBatch b, Vector2 position, float layerDepth, Dictionary<TileSheet, Texture2D> dict, Vector2 offset, float zoom, Point xy, StardewDropsGameMenu menu)
        {
            var x = xy.X; 
            var y = xy.Y;
