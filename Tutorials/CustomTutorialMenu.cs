...
namespace Tutorials
{
    internal class CustomTutorialMenu : IClickableMenu
    {
        ...
        public CustomTutorialMenu(TutorialData data) : base(Game1.uiViewport.Width / 2 - (600 + borderWidth * 2) / 2, Game1.uiViewport.Height / 2 - (600 + borderWidth * 2) / 2 - 192, 600 + borderWidth * 2, 600 + borderWidth * 2 + 192, true)
        {
            data.Frames.Add(new()
            {
