namespace AdvancedGiftReactions
{
    public partial class ModEntry
    {
        public static void ModifyGiftTaste(ref int taste, int num)
        {
            ...
            {
                case 0:
                    if (Config.LovedToLiked > -1 && num >= Config.LovedToLiked)
                    {
                        taste = 2;
                    ...
                    break;
                case 2:
                    if (Config.LikedToNeutral > -1 && num >= Config.LikedToNeutral)
                    {
                        taste = 8;
                    ...
                    break;
                case 8:
                    if (Config.NeutralToDisliked > -1 && num >= Config.NeutralToDisliked)
                    {
                        taste = 4;
                    ...
                    break;
                case 4:
                    if (Config.DislikedToHated > -1 && num >= Config.DislikedToHated)
                    {
                        taste = 6;
                    }
                    break;
