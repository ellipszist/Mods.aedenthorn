...
namespace TreeHat
{
    ...
    public partial class ModEntry : Mod
    {
        ...
        public static string seedKey = "aedenthorn.TreeHat/seed";
        public static string daysKey = "aedenthorn.TreeHat/days";
        public static string phaseKey = "aedenthorn.TreeHat/phase";
        public static string phasesKey = "aedenthorn.TreeHat/phases";
        public static string rowKey = "aedenthorn.TreeHat/row";
        public static string grownKey = "aedenthorn.TreeHat/grownKey";
        public static string xKey = "aedenthorn.TreeHat/x";
        public static string yKey = "aedenthorn.TreeHat/y";
